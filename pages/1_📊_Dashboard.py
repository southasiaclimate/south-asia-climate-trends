...
# If a city was passed via URL (?city=...), it takes priority — this lets
# external pages (like the GitHub Pages landing page) link directly to a
# specific city. Otherwise, fall back to the in-app Home page search bar.
query_city = st.query_params.get("city")
default_city = query_city or st.session_state.get("selected_city", "Rawalpindi")
